<%@ Page Title="Admin Product Details Page" Language="C#" MasterPageFile="~/OCRAdmin.master" AutoEventWireup="true"
    CodeFile="AdminMovieDetails.aspx.cs" Inherits="AdminMovieDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="adminPlaceHolder" runat="Server">
    ...
    <p>
        ...
        <p>
            <asp:Button ID="updateProduct" runat="server" Text="Update Movie" OnClick="createProduct_Click" />
        </p>
</asp:Content>
